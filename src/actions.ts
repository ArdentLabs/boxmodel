import { Types, Schema, Actions, Params } from '../index'
...
export function generateActions(
  ...
  types: Types,
  // A normalizr schema used to flatten the API response and keep everything nice and tidy.
  schema: Schema,
): Actions {
  const url = `${modelName}s`
